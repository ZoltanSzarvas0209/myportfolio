...
class UserProfileFormTests(TestCase):
    ...
    def test_user_profile_form_placeholders(self):
        ...
        self.assertEqual(form.fields['default_phone_number'].widget.attrs
                         ['placeholder'], 'Phone Number')
        self.assertEqual(form.fields['default_country'].widget.attrs
                         ['placeholder'], 'Country')
        self.assertEqual(form.fields['default_postcode'].widget.attrs
                         ['placeholder'], 'Postal Code')
        self.assertEqual(form.fields['default_town_or_city'].widget.attrs
                         ['placeholder'], 'Town or City')
        self.assertEqual(form.fields['default_street_address1'].widget.attrs
                         ['placeholder'], 'Street Address 1')
        self.assertEqual(form.fields['default_street_address2'].widget.attrs
                         ['placeholder'], 'Street Address 2')
        self.assertEqual(form.fields['default_county'].widget.attrs
                         ['placeholder'], 'County')
